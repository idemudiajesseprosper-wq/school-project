...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await res.json();
      if (data.success) { toast.success("Account created! Check your email to verify."); router.push("/login/student"); }
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .rp-grid { position: absolute; inset: 0; background-image: radial-gradient(rgba(255,255,255,0.05) 1px, transparent 1px); background-size: 28px 28px; pointer-events: none; }
        .rp-card { position: relative; z-index: 10; width: 100%; max-width: 480px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 16px; padding: 36px 32px 32px; animation: fadeUp 0.7s ease both; }
        ...
        .rp-steps { display: flex; align-items: center; gap: 0; margin-bottom: 28px; }
        .rp-step { display: flex; align-items: center; gap: 7px; flex: 1; }
        .rp-step-dot { width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-family: 'Lato', sans-serif; font-size: 11px; font-weight: 700; flex-shrink: 0; transition: all 0.3s; }
        ...
        .rp-step-label { font-family: 'Lato', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; transition: color 0.3s; }
        ...
        .rp-step-line { flex: 1; height: 1px; background: rgba(255,255,255,0.08); margin: 0 6px; }
        ...
        .rp-title { font-family: 'Playfair Display', serif; font-weight: 900; font-size: 1.6rem; color: #fff; line-height: 1.15; margin-bottom: 4px; }
        .rp-title em { font-style: italic; color: #93c5fd; }
        .rp-subtitle { font-family: 'Lato', sans-serif; font-weight: 300; font-size: 0.82rem; color: rgba(255,255,255,0.38); line-height: 1.6; }
        ...
        .rp-input, .rp-select { width: 100%; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; padding: 11px 14px; font-family: 'Lato', sans-serif; font-size: 13px; font-weight: 400; color: rgba(255,255,255,0.85); outline: none; transition: border-color 0.2s, background 0.2s; -webkit-appearance: none; }
        ...
        .rp-code-input { width: 100%; background: rgba(37,99,235,0.06); border: 1px solid rgba(37,99,235,0.25); border-radius: 8px; padding: 14px 18px; font-family: 'Lato', sans-serif; font-size: 18px; font-weight: 700; letter-spacing: 0.25em; text-align: center; color: #93c5fd; outline: none; transition: border-color 0.2s, background 0.2s; text-transform: uppercase; }
        .rp-code-input::placeholder { color: rgba(147,197,253,0.25); letter-spacing: 0.15em; font-size: 13px; font-weight: 400; }
        .rp-code-input:focus { border-color: rgba(37,99,235,0.6); background: rgba(37,99,235,0.1); }
        .rp-info-box { background: rgba(37,99,235,0.08); border: 1px solid rgba(37,99,235,0.18); border-radius: 8px; padding: 12px 14px; margin-bottom: 20px; display: flex; gap: 10px; align-items: flex-start; }
        ...
        .rp-divider-text { font-family: 'Lato', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; color: rgba(255,255,255,0.2); white-space: nowrap; }
        .rp-foot { font-family: 'Lato', sans-serif; font-size: 12px; color: rgba(255,255,255,0.22); margin-top: 20px; text-align: center; }
          ...
          {step === 1 && (
            <div style={{ animation: "fadeIn 0.4s ease both" }}>
              ...
              <div className="rp-field">
                ...
                <input className="rp-input" placeholder="e.g. Chukwuemeka Daniel" value={form.fullName} onChange={(e) => update("fullName", e.target.value)} />
              </div>
              ...
              <div className="rp-grid-2">
                <div className="rp-field">
                  ...
                  <select className="rp-select" value={form.classLevel} onChange={(e) => update("classLevel", e.target.value)}>
              ...
              <div className="rp-divider"><div className="rp-divider-line" /></div>

              <div className="rp-grid-2">
                <div className="rp-field">
                  <label className="rp-label">Parent / Guardian</label>
                  <input className="rp-input" placeholder="Full name" value={form.parentName} onChange={(e) => update("parentName", e.target.value)} />
                </div>
                <div className="rp-field">
          ...
          {step === 2 && (
            <form onSubmit={handleSubmit} style={{ animation: "fadeIn 0.4s ease both" }}>
              ...
              <div className="rp-field">
                ...
                <input type="email" className="rp-input" placeholder="your@email.com" value={form.email} onChange={(e) => update("email", e.target.value)} />
              </div>
              <div className="rp-field">
              ...
              <button type="button" className="rp-btn rp-btn-ghost" onClick={() => setStep(1)}>← Back</button>
            </form>
          )}
