...
const StudentIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M24 6L12 12L24 18L36 12L24 6Z"
      stroke="currentColor"
      strokeWidth="1.5"
        ...
        <div className="lp-inner">
          ...
          <div className="lp-brand">
            <div className="lp-logo-ring">
              <img
                src="/logo.PNG"
                alt="Winners' Foundation School"
                width={40}
                height={40}
                style={{ objectFit: "contain" }}
              />
            </div>
            <p className="lp-school-name">
          ...
          <div className="lp-cards">
            <Link href="/applicant/login" className="lp-card applicant">
              ...
              <p className="lp-card-desc">
                Complete your admission form and pay the enrollment fee.
              </p>
            ...
            <Link href="/login/student" className="lp-card student">
              ...
              <span className="lp-card-tag">Portal</span>
              <div className="lp-card-title">School Portal</div>
              <p className="lp-card-desc">
                Students, teachers, and admins sign in here.
              </p>
              <div className="lp-card-cta">
                Sign In
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
