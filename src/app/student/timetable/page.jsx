    ...
    <aside style={S.sidebar}>
      <div style={S.sidebarLogo}>
        ...
        <div>
          ...
          <p style={S.logoSub}>Student Portal</p>
        </div>
      </div>
      <nav style={S.sideNav}>
        ...
        {NAV_ITEMS.map((item) => (
          <a
            key={item.label}
            href={item.href}
            className={`nav-link${item.active ? " nav-active" : ""}`}
          >
            {item.icon}
      ...
      <div style={S.sideFooter}>
        <a href="/student" style={S.backLink}>
          ← Back to Dashboard
        </a>
      </div>
    </aside>
...
export default function StudentTimetablePage() {
  ...
  return (
    <div style={S.page}>
      ...
      <div className="tt-desktop-sidebar">
        <Sidebar />
      </div>
      ...
      <main style={S.main}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <h1 style={S.pageTitle}>
                {timetable?.class || "Class"} Timetable
              </h1>
            </div>
          </div>
          ...
          <div className="tt-view-toggle" style={S.viewToggle}>
            {["day", "week"].map((mode) => (
              <button
                ...
                style={{
                  ...S.viewBtn,
                  background: viewMode === mode ? "#3b5bdb" : "transparent",
        ...
        {!timetable ? (
          <div style={S.emptyWrap}>
            ...
            <p style={S.emptyMsg}>
              Your teacher hasn't published a timetable for your class yet.
              Check back soon.
            </p>
          </div>
        ) : (
              ...
              <div className="tt-day-view">
                ...
                <div style={{ display: "grid", gap: 10 }}>
                  {(todayData?.periods || []).map((period) => {
                    const ps =
                      PERIOD_STYLES[period.type] || PERIOD_STYLES.subject;
                    return (
                      <div
                      ...
                      >
                        <div style={S.periodLeft}>
                          ...
                          <div style={S.periodTimeCol}>
                            <p style={S.periodTime}>
                              {period.startTime || "--"}–
                              {period.endTime || "--"}
                            </p>
                            <p style={{ ...S.periodNum, color: ps.color }}>
                        ...
                        <div style={S.periodRight}>
                          <p style={{ ...S.periodSubject, color: ps.color }}>
                            {period.type === "subject"
                              ...
                              : period.type.charAt(0).toUpperCase() +
                                period.type.slice(1)}
                          </p>
                          {period.teacherName && (
                            <p style={S.periodTeacher}>{period.teacherName}</p>
                          )}
                          <span
                            style={{
                              ...S.typeBadge,
              ...
              >
                {timetable.days?.map((day) => (
                  <div
                    ...
                    style={{
                      ...S.weekDayCard,
                      borderColor: isToday(day.day) ? "#3b5bdb" : "#e2e8f0",
                    }}
                  >
                ...
                <table style={S.table}>
                  <thead>
                    <tr style={{ background: "#0f172a" }}>
                      <th style={{ ...S.th, color: "#94a3b8", width: 110 }}>
                        Day
                      </th>
                      {Array.from({ length: 8 }, (_, i) => (
                        <th key={i} style={{ ...S.th, color: "#94a3b8" }}>
                          Period {i + 1}
                        </th>
                      ))}
                    </tr>
                    ...
                    {timetable.days?.map((day, dIdx) => (
                      ...
                      >
                        ...
                        >
                          ...
                          {isToday(day.day) && (
                            <span style={{ ...S.todayBadge, fontSize: 9 }}>
                              Today
                            </span>
                          )}
                        </td>
                          ...
                          return (
                            <td key={period.periodNumber} style={S.periodCell}>
                              {period.type !== "subject" ? (
                                ...
                                >
                                  <p style={{ ...S.cellType, color: ps.color }}>
                                    {period.type}
                                  </p>
                                  <p style={S.cellTime}>
                                    {period.startTime || "--"}–
        ...
        <nav style={S.mobileBottomNav} className="tt-bottom-nav">
          {NAV_ITEMS.map((item) => (
            <a
              ...
              style={{
                ...S.mobileNavItem,
                color: item.active ? "#3b5bdb" : "#94a3b8",
              }}
            >
              {item.icon}
              <span
                style={{ fontSize: 9, fontWeight: item.active ? 700 : 500 }}
              >
                {item.label}
              </span>
            </a>
