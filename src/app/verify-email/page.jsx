...
export default function VerifyEmailPage() {
  ...
  useEffect(() => {
    ...
    else setStatus("error"), setMessage("Invalid verification link.");
  }, [token]);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        border: "1px solid #e8edf3", boxShadow: "0 4px 24px rgba(0,0,0,0.06)",
        textAlign: "center",
      }}>
        ...
        {status === "loading" && (
          <>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "22px", fontWeight: "900", color: "#0a0a0a", marginBottom: "8px" }}>
              Verifying your email...
            </h2>
            <p style={{ color: "#6b7280", fontSize: "14px" }}>Please wait a moment.</p>
          </>
        )}
        ...
        {status === "success" && (
          <>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "24px", fontWeight: "900", color: "#0a0a0a", marginBottom: "12px" }}>
              Email Verified!
            </h2>
