      ...
      <header style={s.header}>
        <div style={s.headerInner}>
          <div style={s.headerLeft}>
            ...
            <p style={s.subheading}>Control student result visibility by class, session and term</p>
          </div>
        ...
        <div style={s.statsRow}>
          ...
          <div style={s.statCard}>
            <span style={{ ...s.statNumber, color: "#16a34a" }}>{publishedCount}</span>
            <span style={s.statLabel}>Published</span>
          </div>
          <div style={{ ...s.statCard, borderRight: "none" }}>
            <span style={{ ...s.statNumber, color: "#d97706" }}>{unpublishedCount}</span>
        ...
        <section style={s.card}>
          <div style={s.cardHeader}>
            ...
            <div>
              ...
              <p style={s.cardSubtitle}>Select criteria then publish or unpublish results</p>
            </div>
          </div>
        ...
        <section style={s.card}>
          <div style={s.cardHeader}>
            ...
            <div>
              ...
              <p style={s.cardSubtitle}>{publications.length} record{publications.length !== 1 ? "s" : ""} found</p>
            </div>
          </div>
            ...
            <table style={s.table}>
              ...
              <tbody>
                {publications.map((item, i) => (
                  ...
                  >
                    <td style={s.td}><span style={s.classChip}>{item.className}</span></td>
                    <td style={{ ...s.td, color: "#475569" }}>{item.academicSession}</td>
                    <td style={{ ...s.td, color: "#475569" }}>{item.term}</td>
                    <td style={s.td}>
                      <span style={item.isPublished ? s.badgePublished : s.badgeUnpublished}>
                        <span style={{ ...s.dot, background: item.isPublished ? "#16a34a" : "#94a3b8" }} />
...
function EmptyState() {
  return (
    <div style={{ padding: "40px 20px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
      <div style={{ width: 52, height: 52, borderRadius: 14, background: "#f1f5f9", border: "1px solid #e2e8f0", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 4 }}>
      ...
      <p style={{ fontSize: 14, fontWeight: 700, color: "#94a3b8", margin: 0 }}>No records yet</p>
      <p style={{ fontSize: 12, color: "#cbd5e1", margin: 0 }}>Publish or unpublish a result to see history here.</p>
    </div>
  );
}

function CheckIcon() {
  return <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24" style={{ flexShrink: 0 }}><path d="M5 12l5 5L20 7" strokeLinecap="round" strokeLinejoin="round" /></svg>;
}
function XIcon() {
  return <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24" style={{ flexShrink: 0 }}><path d="M18 6L6 18M6 6l12 12" strokeLinecap="round" strokeLinejoin="round" /></svg>;
}
...
const s = {
  ...
  badge: {
    ...
    textTransform: "uppercase", color: "#d97706", background: "#fef3c7",
    border: "1px solid #fde68a", borderRadius: 20, padding: "3px 10px", marginBottom: 8,
  },
  heading: {
  ...
  statCard: {
    ...
    padding: "14px 12px", borderRight: "1px solid #f1f5f9",
  },
  statNumber: {
  ...
  statLabel: {
    ...
    textTransform: "uppercase", color: "#94a3b8", marginTop: 3,
  },
  ...
  btn: {
    ...
    fontFamily: "'DM Sans', sans-serif", flex: "1 1 auto", justifyContent: "center",
  },
  btnPublish: {
    background: "linear-gradient(135deg, #16a34a 0%, #15803d 100%)",
    color: "#fff", border: "none", boxShadow: "0 4px 14px rgba(22,163,74,0.25)",
  },
  btnUnpublish: {
  ...
  // Table
  tableWrapper: { borderRadius: 10, border: "1px solid #e2e8f0", overflow: "hidden" },
  ...
  classChip: {
    ...
    border: "1px solid #fde68a", borderRadius: 6, padding: "2px 10px",
  ...
  mobileCard: {
    background: "#f8fafc", border: "1px solid #e2e8f0",
    borderRadius: 12, padding: "14px", animation: "fadeUp 0.3s ease both",
  },
  mobileCardTop: {
    display: "flex", alignItems: "center",
    justifyContent: "space-between", marginBottom: 8,
  },
  mobileCardBody: { display: "flex", alignItems: "center", gap: 6, marginBottom: 6 },
