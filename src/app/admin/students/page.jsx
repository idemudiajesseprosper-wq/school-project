    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          >
            <LocationIcon /> 2, Airhueghiomon street, Osazuwa, Off Etete Road,
            Enogie, Benin City
          </span>
        </div>
...
export default function StudentsPage() {
  ...
  const toggleSuspend = async (studentId, suspended) => {
    try {
      ...
      if (data.success) {
        ...
        setStudents((prev) =>
          prev.map((s) =>
            s._id === studentId ? { ...s, isSuspended: !s.isSuspended } : s,
          ),
        );
      } else toast.error(data.message);
    } catch {
  ...
  const stats = [
    ...
    {
      label: "Online Now",
      value: students.filter((s) => s.isOnline).length,
      color: "#16a34a",
      bg: "#f0fdf4",
    },
    {
        ...
        >
          ...
          <div style={{ padding: "28px 24px", flex: 1 }}>
            <div style={{ marginBottom: "24px" }}>
              ...
              <p
                style={{ color: "#6b7280", marginTop: "6px", fontSize: "14px" }}
              >
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      transition: "all 0.15s",
                      borderColor:
                        filterStatus === f.key ? "#2563EB" : "#e5e7eb",
                          ...
                          <td style={{ padding: "15px 18px" }}>
                            ...
                            >
                              ...
                              <ActionBtn
                                ...
                                color={
                                  student.isSuspended ? "#16a34a" : "#d97706"
                                }
                                label={
